...
void main() {
  ...
  // pattern 24
  // vec2 gridUv = vec2(floor(vUv.x * 10.0) * 0.1, floor(vUv.y * 10.0) * 0.1);
  // float strength = random(gridUv);

  // pattern 25
  // vec2 gridUv = vec2(floor(vUv.x * 10.0) * 0.1, floor(vUv.y * 10.0 + vUv.x * 5.0) * 0.1);
  // float strength = random(gridUv);
  ...
  // float strength = 0.15 / distance(lightUvX, vec2(0.5));
  // strength *= 0.15 / distance(lightUvY, vec2(0.5));
