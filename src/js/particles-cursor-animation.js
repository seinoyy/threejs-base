...
displacement.glowImage.src = '../../static/particles-cursor-animation/glow.png'
...
const particlesMaterial = new THREE.ShaderMaterial({
  ...
  uniforms:
  {
    ...
    uPictureTexture: new THREE.Uniform(textureLoader.load('../../static/particles-cursor-animation/picture-1.png')),
