...
import particlesVertexShader from '@/shaders/particlesMorphing/vertex.glsl'
import particlesFragmentShader from '@/shaders/particlesMorphing/fragment.glsl'
...
gltfLoader.load('../../static/models/models.glb', (gltf) => {
  particles = {}
  particles.index = 0
